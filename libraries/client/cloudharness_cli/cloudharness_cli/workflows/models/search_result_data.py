...
class SearchResultData(object):
    ...
    def __init__(self, continue_token=None, local_vars_configuration=None):  # noqa: E501
        """SearchResultData - a model defined in OpenAPI"""  # noqa: E501
    ...
    def continue_token(self):
        """Gets the continue_token of this SearchResultData.  # noqa: E501

        token to use for pagination  # noqa: E501

        :return: The continue_token of this SearchResultData.  # noqa: E501
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchResultData):
            return False
