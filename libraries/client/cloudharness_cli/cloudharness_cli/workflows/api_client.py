...
from cloudharness_cli.workflows.exceptions import ApiTypeError, ApiValueError, ApiException
from cloudharness_cli.workflows.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CreateAndAccessApi()
        api_instance.delete_operation  # this is an instance of the class Endpoint
        api_instance.delete_operation()  # this invokes api_instance.delete_operation.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_operation.callable or self.callable in this class
