...
from cloudharness_cli.samples.exceptions import ApiTypeError, ApiValueError, ApiException
from cloudharness_cli.samples.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.valid_cookie  # this is an instance of the class Endpoint
        api_instance.valid_cookie()  # this invokes api_instance.valid_cookie.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.valid_cookie.callable or self.callable in this class
