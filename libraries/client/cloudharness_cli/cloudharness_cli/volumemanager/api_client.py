...
from cloudharness_cli.volumemanager.exceptions import ApiTypeError, ApiValueError, ApiException
from cloudharness_cli.volumemanager.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = RestApi()
        api_instance.pvc_name_get  # this is an instance of the class Endpoint
        api_instance.pvc_name_get()  # this invokes api_instance.pvc_name_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.pvc_name_get.callable or self.callable in this class
