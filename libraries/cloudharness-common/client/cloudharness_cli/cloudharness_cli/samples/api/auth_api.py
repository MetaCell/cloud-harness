...
class AuthApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.valid_cookie_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'cookieAuth'
                ],
                'endpoint_path': '/valid-cookie',
                'operation_id': 'valid_cookie',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.valid_token_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'bearerAuth'
    ...
    def valid_cookie(
        ...
        **kwargs
        ...
        >>> thread = api.valid_cookie(async_req=True)
        >>> result = thread.get()
        ...
        return self.valid_cookie_endpoint.call_with_http_info(**kwargs)
    ...
    def valid_token(
        ...
        **kwargs
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.valid_token_endpoint.call_with_http_info(**kwargs)
