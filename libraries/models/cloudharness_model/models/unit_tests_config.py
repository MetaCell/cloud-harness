...
class UnitTestsConfig(CloudHarnessBaseModel):
    """
    
    """ # noqa: E501
    enabled: StrictBool = Field(description="Enables unit tests for this application (default: true)")
    commands: List[StrictStr] = Field(description="Commands to run unit tests")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["enabled", "commands"]
