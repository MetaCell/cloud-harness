...
class DockerfileConfig(CloudHarnessBaseModel):
    """
    Configuration for a dockerfile
    """ # noqa: E501
    build_args: Optional[Dict[str, Any]] = Field(default=None, alias="buildArgs")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["buildArgs"]
