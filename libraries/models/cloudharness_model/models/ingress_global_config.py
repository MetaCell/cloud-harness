...
import importlib
from cloudharness_model.models.ingress_global_config_all_of_letsencrypt import IngressGlobalConfigAllOfLetsencrypt

class IngressGlobalConfig(CloudHarnessBaseModel):
    """
    ...
    letsencrypt: Optional[IngressGlobalConfigAllOfLetsencrypt] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "letsencrypt": IngressGlobalConfigAllOfLetsencrypt.from_dict(obj["letsencrypt"]) if obj.get("letsencrypt") is not None else None,
