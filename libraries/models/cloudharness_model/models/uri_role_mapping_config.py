...
class UriRoleMappingConfig(BaseModel):
    """
    Defines the application Gatekeeper configuration, if enabled (i.e. `secured: true`.
    """ # noqa: E501
    uri: Annotated[str, Field(strict=True)]
    roles: List[StrictStr] = Field(description="Roles allowed to access the present uri")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["uri", "roles"]
