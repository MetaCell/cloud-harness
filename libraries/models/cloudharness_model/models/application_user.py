...
class ApplicationUser(CloudHarnessBaseModel):
    """
    Defines a user
    """ # noqa: E501
    username: StrictStr
    password: Optional[StrictStr] = None
    client_roles: Optional[List[StrictStr]] = Field(default=None, alias="clientRoles")
    realm_roles: Optional[List[StrictStr]] = Field(default=None, alias="realmRoles")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["username", "password", "clientRoles", "realmRoles"]
