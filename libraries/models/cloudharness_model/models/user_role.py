...
class UserRole(CloudHarnessBaseModel):
    """
    UserRole
    """ # noqa: E501
    attributes: Optional[Dict[str, Any]] = None
    client_role: Optional[StrictBool] = Field(default=None, alias="clientRole")
    ...
    __properties: ClassVar[List[str]] = ["attributes", "clientRole", "composite", "containerId", "description", "id", "name"]
