...
class UserCredential(CloudHarnessBaseModel):
    """
    UserCredential
    """ # noqa: E501
    created_date: Optional[StrictInt] = Field(default=None, alias="createdDate")
    credential_data: Optional[StrictStr] = Field(default=None, alias="credentialData")
    id: Optional[StrictStr] = None
    priority: Optional[StrictInt] = None
    secret_data: Optional[StrictStr] = Field(default=None, alias="secretData")
    temporary: Optional[StrictBool] = None
    type: Optional[StrictStr] = None
    user_label: Optional[StrictStr] = Field(default=None, alias="userLabel")
    value: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["createdDate", "credentialData", "id", "priority", "secretData", "temporary", "type", "userLabel", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credentialData": obj.get("credentialData"),
            "id": obj.get("id"),
