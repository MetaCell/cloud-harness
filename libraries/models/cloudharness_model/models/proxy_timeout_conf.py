...
class ProxyTimeoutConf(CloudHarnessBaseModel):
    """
    
    """ # noqa: E501
    keepalive: Optional[StrictInt] = None
    read: Optional[StrictInt] = None
    send: Optional[StrictInt] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["keepalive", "read", "send"]
