...
class CloudHarnessBaseModel(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Any:
        ...
        Union models (anyOf/oneOf) generated by the OpenAPI generator resolve their
        actual instance by calling this on each candidate schema.
        """
        return cls.from_dict(json.loads(json_str))

    def to_json(self) -> str:
        """Serialize to a JSON string, the counterpart of `from_json`."""
