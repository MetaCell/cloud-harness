...
def test_helm_values_deserialize():
    ...
    assert getattr(app.harness.database, "pass") == "metacell"
    assert app.harness.database["pass"] == "metacell"
