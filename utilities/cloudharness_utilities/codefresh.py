...
from .constants import HERE, BUILD_STEP_BASE, BUILD_STEP_STATIC, BUILD_STEP_PARALLEL, BUILD_STEP_INSTALL, CODEFRESH_PATH, CODEFRESH_BUILD_PATH, \
...
def create_codefresh_deployment_scripts(root_paths, tag="${{CF_REVISION}}", codefresh_path=CODEFRESH_PATH, include=[]):
    """
