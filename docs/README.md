...
- [Create and configure applications](./applications)
  ...
  - [Add and use secrets](./applications/secrets)
    - [Secret manager: 1Password](./applications/secrets/managers/onepassword.md)
    - [Secret manager: AWS Secrets Manager](./applications/secrets/managers/aws.md)
